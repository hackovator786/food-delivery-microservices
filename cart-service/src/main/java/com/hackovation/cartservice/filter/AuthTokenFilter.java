package com.hackovation.cartservice.filter;

import com.hackovation.cartservice.exception.AuthFilterException;
import com.hackovation.cartservice.util.AccessTokenUtils;
import com.hackovation.cartservice.util.CustomHeaderRequestWrapper;
...
public class AuthTokenFilter extends OncePerRequestFilter {
        ...
        try {
            ...
            if (jwt != null) {
                ...
                if (userId == null || userId.isEmpty() || userRoleId == null
                        || !roles.containsKey(userRoleId)) {
                    throw new AuthFilterException("Invalid JWT Token");
                }
                List<String> rolesList = List.of(roles.get(userRoleId));
    ...
    private String parseJwt(HttpServletRequest request) {
        return accessTokenUtils.getAccessTokenFromHeader(request);
    }
}