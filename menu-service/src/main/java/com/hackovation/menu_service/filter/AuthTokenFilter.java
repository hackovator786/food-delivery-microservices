package com.hackovation.menu_service.filter;


import com.hackovation.menu_service.exception.AuthFilterException;
import com.hackovation.menu_service.util.AccessTokenUtils;
import com.hackovation.menu_service.util.CustomHeaderRequestWrapper;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            if (jwt != null) {
                ...
                customHeaders.put("restaurantId", restaurantId);
